...
from .models import UserAccount,OnOF
...
def onlineoffline(request):
    onlineoroffline = OnOF.objects.order_by('st')
    return render(request, "profilebase.html", {'onlineoroffline': onlineoroffline})
